...
export const API_URL = "http://192.168.101.22:5000/api";
...
export const updateLocation = (busId, latitude, longitude) =>
  api.put(`/buses/${busId}/location`, { latitude, longitude }).then((r) => r.data);
